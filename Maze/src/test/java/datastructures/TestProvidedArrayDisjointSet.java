...
public class TestProvidedArrayDisjointSet extends BaseTest {
    ...
    public void testRank() {
        ...
        forest.union("b", "c");
        forest.union("c", "d");
        assertTrue(forest.findSet("d") != forest.findSet("e"));
        forest.union("d", "e");
        assertTrue(forest.findSet("a") == forest.findSet("e"));
    }
    ...
    public void testEdgeCase() {
        ...
        forest.makeSet(12);
        forest.makeSet(13);
        assertTrue(forest.findSet(2) != forest.findSet(13));
        assertTrue(forest.findSet(2) == forest.findSet(1));
        forest.union(2, 13);
        assertTrue(forest.findSet(2) == forest.findSet(13));
    }
}
